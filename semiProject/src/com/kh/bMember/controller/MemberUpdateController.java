...
public class MemberUpdateController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BMember m = new BMember(userId,userName,phone,address,email,ssn,userNick,schoolNo,school_st);
		
		BMember updateMem = new BMemberService().updateMember(m);

		if(updateMem != null) {
			request.getSession().setAttribute("alertMsg", "정보 수정 완료");
