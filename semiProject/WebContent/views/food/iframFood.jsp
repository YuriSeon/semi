...
// 계획 : 부모에서 음식 이름이랑 현위치 가져와서 지도 펼치고 거기에 점심할꺼임
...
function placesSearchCB(data, status, pagination) {
    if (status === kakao.maps.services.Status.OK) {
    	...
    	console.log($("#ssx", parent.document).contents().find("allFoodRight").prevObject[5]);
    	$("#ssx", parent.document).contents().find("allFoodRight").prevObject[5].click();
        alert("검색 결과가 존재하지 않기 때문에 다음 음식으로 넘어 갑니다.");
