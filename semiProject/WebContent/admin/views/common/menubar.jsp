...
#cover {
    ...
    background-color: #71d6ec;
    border-radius: 20px;
    box-shadow: 0 10px 40px #a5d5ff, 0 0 0 20px #ffffffeb;
    transform: scale(0.6);
    border: 10px green;
}
...
<body>
	...
	</a> <a href="<%=contextPath %>/main.admin"> <i class="fas fa-heart"></i> <span>Go community</span> <!-- 매핑주소 확인 -->
